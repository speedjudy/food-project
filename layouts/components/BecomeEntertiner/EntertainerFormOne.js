...
import entertainers from "../../../public/assets/enterstepone.json";
import { useSession, signIn, signOut } from "next-auth/react";



const EntertainerFormOne = () => {
  ...
  return (
    <div>
      <h2 className="text-dark-500 pt-12 text-center text-5xl font-bold tracking-widest max-sm:text-xl">
        {entertainer[0].title}
      </h2>
      <div className="place-content-center content-center">
        <p className="mt-12 text-center text-3xl font-black text-dark max-sm:text-lg max-sm:mt-3">
        {entertainer[0].semititle}
        </p>
        <div className="mb-3 mt-8 flex place-content-center">
...
export default EntertainerFormOne;
