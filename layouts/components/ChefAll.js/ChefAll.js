...
import CookCard from "../BookaChef/CookCard";
...
const ChefAll = () => {
  ...
  return (
    <div className="mb-12 mt-12">
      {/* <div className="mb-12">
        <button className="h-full items-center rounded-md border border-gray-300 bg-transparent px-4 py-2 text-sm font-bold text-dark hover:bg-orange-600 hover:text-white">
          <span className="h-88 mr-2 w-48 rounded-md bg-orange-500 pt-1 pl-1 pr-1 pb-1 text-white">
            1
          </span>
          Filters
        </button>
      ...
      <div className="grid grid-cols-3 gap-1 max-sm:ml-8 max-sm:grid-cols-1">
        {data == undefined
          ? setData([])
          : data.map((e) => {
              return (
